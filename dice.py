...
def start():
    print("Let's play the game of dice")
    while game():
        pass
    scores()

def game():
    print("The computer will help you throw your dice")
    throw()
    return play_again()
...
def throw():
    ...
    while True:
        ...
        try:
            ...
            pass
        print("Ooops! i didn't understand that. Enter 1,2,3,4 or 5")
    if rerolls == 0 :
